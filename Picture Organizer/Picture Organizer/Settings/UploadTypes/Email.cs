...
{
	[Serializable]
	public class Email : UploadBase
	{
		#region Encryption
		private const string ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
		private const string NUMERIC = "0123456789";
		private const string ALPHA_NUMERIC = ALPHA + NUMERIC;
		private string passPhrase = "r1x3pnkmc4g9buxhuemp56ab13x8fbhq";        // can be any string
		private string saltValue = "zu0g84i3q2zlcemsd5c7ipksd7ik6zu4";        // can be any string
		...
		public enum AttachModes : int
		{
			[XmlEnum(Name = "All Pictures")]
			All,
			[XmlEnum(Name = "Compressed File")]
			Compressed
		}

		private AttachModes attachMode;
		private string to;
		private string from;
		private bool promptSend;
		...
		//public bool PromptSend
		//{
		//    get { return this.promptSend; }
		//    set { this.promptSend = value; }
		//}

        public override UploadSettings.UploadType GetMethod()
        {
            return UploadSettings.UploadType.Email;
        }

        public override void LoadSettings(object obj)
        {
			Email settings = obj as Email;
            if (settings != null)
            {
				//this.To = settings.To;
				//this.From = settings.From;
				//this.PromptSend = settings.PromptSend;
				this.AttachMode = settings.AttachMode;
            }
        }
        ...
        public override void LoadDefaults()
		{
			//this.To = "";
			//this.From = "";
			//this.PromptSend = true;
			this.AttachMode = AttachModes.All;
		}
