...
{
	[Serializable]
	public class Picasa : UploadBase
	{
		public enum PicasaPrivacyType : int
		{
			[XmlEnum(Name = "Public")]
			Public,
		...
		private PicasaPrivacyType privacy;
		private const string ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
		private const string NUMERIC = "0123456789";
		private const string ALPHA_NUMERIC = ALPHA + NUMERIC;
		private string passPhrase = "jcu1u83kh9x9udkvqhpcp5e49w6o6ua1";        // can be any string
		private string saltValue = "dgnuol8ko0gez76td1y0e47mvi93q7xe";        // can be any string
		...
		public PicasaPrivacyType Privacy
		{
        ...
        {
            return UploadSettings.UploadType.Picasa;
        }

        public override void LoadSettings(object obj)
        {
            Picasa settings = obj as Picasa;
            if (settings != null)
			{
        ...
        public override void LoadDefaults()
        {
			...
			this.Privacy = PicasaPrivacyType.Private;
        }
